...
// Expose bill actions used by inline HTML handlers and other modules.
window.addToBill = addToBill;
window.resetBill = resetBill;
window.updateBillTotal = updateBillTotal;
window.NewOrder = NewOrder;
window.displayHeld = displayHeld;
window.toggleDiscountPopup = toggleDiscountPopup;
window.saveAndPrintBill = saveAndPrintBill;
window.saveAndPrintKOT = saveAndPrintKOT;
window.saveBill = saveBill;
window.holdBill = holdBill;
window.displayTodaysOrders = displayTodaysOrders;
